                        ...
                        return (
                            <>
                                ...
                                <div className="details">
                                    <Table>
                                        <tr>
                                            <td><p> <strong>Restaurant :</strong> {ek.rname}</p>
                                                <p> <strong>Price :</strong> {ek.price}</p>
                                                <p> <strong>Dishes :</strong> {ek.address}</p>

                                            </td>
                                            <td>
                                                <p> <strong>Rating :</strong> <span style={{ backgroundColor: "green", color: "white", padding: "2px 5px", borderRadius: "5px" }}>{data.rating}&nbsp;★</span></p>
